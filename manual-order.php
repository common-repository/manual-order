...
/* check CodersManualOrder class exists anywhere else */

if (!class_exists('CodersManualOrder')) :

    /*CodersManualOrder class defination*/
...
new CodersManualOrder(); /*CodersManualOrder class execute*/